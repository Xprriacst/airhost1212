    ...
    <div className="flex h-screen overflow-hidden">
        ...
        <aside className="w-64 bg-gray-900 text-white flex-shrink-0">
          <nav className="h-full flex flex-col py-6">
            ...
            <div className="mt-6 space-y-1">
              <Link
                to="/conversations"
                className="flex items-center px-6 py-2 text-gray-300 hover:bg-gray-800 hover:text-white"
              >
            ...
            <Link
              to="/settings"
              className="flex items-center px-6 py-2 mt-auto text-gray-300 hover:bg-gray-800 hover:text-white"
            >
      ...
      <main className={`flex-1 flex flex-col ${showMobileMenu ? 'mt-14' : ''}`}>
        <Routes>
          ...
          <Route
            path="/properties/:propertyId/conversations/:conversationId"
